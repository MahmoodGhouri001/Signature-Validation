...
#input_img1 = cv2.imread(file_path1)
file_path2 = filedialog.askopenfilename()
#input_img2 = cv2.imread(file_path2)

originl_img = crop(file_path1,image_name= "compare1")
contrast_img = crop(file_path2,image_name= "compare2")
